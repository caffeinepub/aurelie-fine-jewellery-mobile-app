...
function TermsConditionsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerPageStyleScope, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-serif font-bold text-bottle-green-dark mb-8", children: "Terms & Conditions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-lg max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "whitespace-pre-wrap text-bottle-green-dark leading-relaxed", children: (siteContent == null ? void 0 : siteContent.termsOfService) || "Terms and conditions content not available." }) })
  ] }) }) });
}
export {
