...
function matchesPriceRange(product: Product, priceRange: PriceRange): boolean {
  ...
  switch (priceRange) {
    ...
    case "5000-10000":
      return priceInRupees >= 5000 && priceInRupees <= 10000;
    case "10000-20000":
      return priceInRupees > 10000 && priceInRupees <= 20000;
    case "above-20000":
      return priceInRupees > 20000;
    default:
      return true;
  }
}
