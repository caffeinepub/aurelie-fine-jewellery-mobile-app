import { ChevronDown, ChevronUp, Image as ImageIcon, Save } from "lucide-react";
import { useState } from "react";
import { toast } from "sonner";
import { type CarouselSlide, ExternalBlob } from "../../backend";
import {
  useGetCarouselSlides,
  useReorderCarouselSlides,
    ...
    <Card className="gold-border admin-surface backdrop-blur mb-6">
      <CardHeader>
        ...
        <p className="text-sm text-bottle-green-medium">
          ...
          Auto-rotates every 2.5 seconds on the homepage.
        </p>
      </CardHeader>
                  ...
                  {slide && !editing?.image ? (
                    ...
                    <div className="relative aspect-video rounded-lg overflow-hidden border border-gold-medium/30">
                      <img
                        ...
                        className="w-full h-full object-cover"
                      />
                      {editing.uploadProgress > 0 &&
                        editing.uploadProgress < 100 && (
                          <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                            <div className="text-white text-sm">
                              Uploading: {editing.uploadProgress}%
                            </div>
                          </div>
                        )}
                    </div>
