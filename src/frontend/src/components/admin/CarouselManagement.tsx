...
import { Upload, ChevronUp, ChevronDown, Save, Image as ImageIcon } from 'lucide-react';
...
export default function CarouselManagement() {
  ...
  const [editingSlides, setEditingSlides] = useState<Record<number, { url: string; image: File | null; uploadProgress: number }>>({});
    ...
    <Card className="gold-border chrome-surface backdrop-blur">
      <CardHeader>
        ...
        <p className="text-sm gold-text opacity-70">
          Manage up to 5 carousel slides. Auto-rotates every 2.5 seconds on the homepage.
        </p>
      </CardHeader>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={updateSlide.isPending || (!hasChanges && !slide)}
