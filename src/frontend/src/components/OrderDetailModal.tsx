...
export default function OrderDetailModal({
  ...
  const { data: isCancellable, isLoading: checkingCancellable } =
    useIsOrderCancellable(order?.id || "");
              ...
              {checkingCancellable ? (
                ...
                <>
                  ...
                  <div className="flex items-start gap-2 p-3 bg-amber-500/10 rounded-lg border border-amber-500/30">
                    ...
                    <p className="text-xs text-amber-700">
                      Cancel is available for 12hrs post order is placed. For
                      more help contact customer support.
                    </p>
                  </div>
                </>
              ) : (
                <div className="flex items-start gap-2 p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Cancellation period has expired. Please contact customer
          ...
          {showCancelForm && (
            <div className="space-y-4 p-4 bg-destructive/5 rounded-lg border border-destructive/30">
              <div className="space-y-2">
                <Label htmlFor="reason" className="gold-text">
                  Cancellation Reason
                </Label>
                <Select
              ...
              {selectedReason === "Other" && (
                <div className="space-y-2">
                  <Label htmlFor="customReason" className="gold-text">
                    Please specify
                  </Label>
                  <Textarea
                    id="customReason"
