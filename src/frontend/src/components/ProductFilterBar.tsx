      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-bottle-green-dark">
              Filters
            </span>
            {activeFilterCount > 0 && (
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Select
            ...
            onValueChange={(v) => onMetalTypeChange(v as MetalType)}
          >
          ...
          <Select
            ...
            onValueChange={(v) => onOccasionChange(v as Occasion)}
          >
