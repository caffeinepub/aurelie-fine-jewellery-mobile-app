    ...
    >
      ...
      >
        ...
        <div className="flex-1 text-center md:text-left max-w-2xl">
          ...
          >
            Born from a passion for timeless beauty, every Aurelie piece is a
            testament to the art of fine jewellery. Our master artisans weave
            heritage craftsmanship with contemporary elegance — creating
